...
public class CarrinhoEndpoint {
	...
	public Response create(Carrinho entity) {
		...
		return Response.created(
				UriBuilder.fromResource(CarrinhoEndpoint.class)
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Carrinho> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT c FROM Carrinho c WHERE c.id = :entityId ORDER BY c.id",
						Carrinho.class);
	...
	@GET
	@Produces("application/json")
	public List<Carrinho> listAll(@QueryParam("start") Integer startPosition,
			@QueryParam("max") Integer maxResult) {
		TypedQuery<Carrinho> findAllQuery = em.createQuery(
				"SELECT DISTINCT c FROM Carrinho c ORDER BY c.id",
				Carrinho.class);
