...
public class ClienteEndpoint
{
   ...
   {
      TypedQuery<Cliente> findByIdQuery = em.createQuery("SELECT DISTINCT c FROM Cliente c LEFT JOIN FETCH c.usuario LEFT JOIN FETCH c.vendas WHERE c.id = :entityId ORDER BY c.id", Cliente.class);
