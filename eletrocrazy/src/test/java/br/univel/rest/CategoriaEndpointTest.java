...
//		super.apagarTodos(ENDPOINT);
	...
	public void testDeleteById() {
		...
		WebTarget destinoGravacao = client.target("http://localhost:8080/eletrocrazy/rest/categoria" + "/2");
	...
	public void testListAll() {
		...
		WebTarget destinoGravacao = client.target("http://localhost:8080/eletrocrazy/rest/categoria");
